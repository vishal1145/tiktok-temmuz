    ...
    >
      <div>
        <ul class="navigation-left">
          ...
          <!-- <li
            @mouseenter="toggleSubMenu"
            :class="{ active: selectedParentMenu == 'mydesk' }"
            class="nav-item"
            data-item="mydesk"
            :data-submenu="false"
          >
          ...
          <!-- <li v-if="isAdmin !== 'User'"
            @mouseenter="toggleSubMenu"
            :class="{ active: selectedParentMenu == 'cars' }"
            class="nav-item"
            data-item="cars"
            :data-submenu="false"
          >
          ...
          <!-- <li
            @mouseenter="toggleSubMenu"
            :class="{ active: selectedParentMenu == 'transaction' }"
            class="nav-item"
          ...
          <!-- <li v-if="isAdmin !== 'User'"
            @mouseenter="toggleSubMenu"
            :class="{ active: selectedParentMenu == 'addBackEndData' }"
            class="nav-item"
          ...
          <!-- <li
            @mouseenter="toggleSubMenu"
            :class="{ active: selectedParentMenu == 'activitylogs' }"
            class="nav-item"
    ...
    >
      <div ref="sidebarChild">
        ...
        <ul
          ...
          data-parent="mydesk"
          :class="{ 'd-block': selectedParentMenu == 'mydesk' }"
        >
          <li class="nav-item">
            <router-link tag="a" class to="/app/mydesk/mydesk">
              <i class="nav-icon i-Clock-3"></i>
              <span class="item-name">{{ "My Desk" }}</span>
            </router-link>
          </li>
        </ul>
        ...
        <ul
          ...
          :class="{ 'd-block': selectedParentMenu == 'accounts' }"
        >
          <li class="nav-item">
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/app/accounts/security">
              <i class="nav-icon fa fa-lock" aria-hidden="true"></i>
              <span class="item-name">{{ "Security" }}</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/app/accounts/eSignature">
              <i class="nav-icon fa fa-sign-language" aria-hidden="true"></i>
              <span class="item-name">{{ "eSignature" }}</span>
            </router-link>
          </li>
          <li class="nav-item" v-if="isHide">
            <router-link tag="a" class to="/app/accounts/stamp">
              <i class="nav-icon fa fa-certificate" aria-hidden="true"></i>
              <span class="item-name">{{ "Stamp" }}</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/app/accounts/inviteConfigurations">
              <i class="nav-icon fa fa-envelope-open" aria-hidden="true"></i>
              <span class="item-name">{{ "Invite Configurations" }}</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link
              tag="a"
              class
              to="/app/accounts/documentConfigurations"
            >
              <i class="nav-icon fa fa-file" aria-hidden="true"></i>
              <span class="item-name">{{ "Documents Configurations" }}</span>
            </router-link>
          </li>
        </ul>
        ...
        <!-- <ul
          class="childNav d-none"
          data-parent="profiledata"
          :class="{ 'd-block': selectedParentMenu == 'profiledata' }"
        >
          <li class="nav-item">
            <router-link tag="a" class to="/app/profiledata/profile">
              <i class="nav-icon i-Clock-3"></i>
        ...
        <ul
          class="childNav d-none"
          data-parent="setting"
          :class="{ 'd-block': selectedParentMenu == 'setting' }"
        >
          <li class="nav-item">
          ...
          <li class="nav-item" v-if="isHide">
            <router-link tag="a" class to="/app/setting/esignature">
              <i class="nav-icon fa fa-sign-language" aria-hidden="true"></i>
              <span class="item-name">{{ "Esignature & Seal" }}</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/app/setting/documents">
              <i class="nav-icon fa fa-file" aria-hidden="true"></i>
