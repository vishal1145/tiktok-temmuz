  ...
  <div>
    ...
    <div class="mb-30">
      <b-card>
        <div class="d-flex justify-content-between align-items-center">
          <b-button @click="back" variant="outline-primary" size="sm"
            >Back</b-button
          >
    ...
    <div class="editScrumBoardContainer d-flex mb-30">
      ...
      <div
        ...
        v-for="(div, key) in getEditBoardList.list"
        :key="key"
      >
            ...
            <b-input-group v-else-if="selectedListId === key" class="mt-3">
              <b-input-group-append>
                <b-button
                  ...
                  size="sm"
                  @click="
                    addCard({ list: div, cardListTitle: addBoard.cardList })
                  "
                  >Add</b-button
                >
              </b-input-group-append>
              ...
              ></b-form-input>
              <b-input-group-append>
                <b-button @click="toggleCard" variant="primary" size="sm"
                  >X</b-button
                >
              </b-input-group-append>
            </b-input-group>
        ...
        <b-form>
          ...
          <b-list-group class="mb-4">
            ...
            >
              ...
              <b-list-group-item class="mb-4 w-100">{{
                comment.text
              }}</b-list-group-item>
            </div>
          </b-list-group>
          ...
          <b-button
            @click.prevent="onSubmit(getEditCardList)"
            type="button"
            variant="primary"
            >Submit</b-button
          >
        ...
        <b-card class="cursor-pointer">
          <div class="card-title mb-0">
            ...
            <b-input-group v-else class="mt-3">
              ...
              ></b-form-input>
              <b-input-group-append>
                <b-button @click="isShow = !isShow" variant="primary" size="sm"
                  >X</b-button
                >
              </b-input-group-append>
            </b-input-group>
