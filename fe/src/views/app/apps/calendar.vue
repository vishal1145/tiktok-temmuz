    ...
    <b-row>
      ...
      <b-col xl="3" lg="4" md="12" class=" mb-30">
        ...
        <b-card class="box mb-30">
          <div class="field">
            <label class="label mb-1"
              ><h5 class="font-weight-500">Period UOM</h5></label
            >
            <div class="control">
          ...
          <div class="field">
            <label class="label mb-1"
              ><h5 class="font-weight-500">Period Count</h5></label
            >
            <div class="control">
              <div class="select mb-3">
          ...
          <div class="field mt-3">
            <label class="label mb-1"
              ><h5 class="font-weight-500">Starting day of the week</h5>
            </label>
            <div class="control">
              <div class="select mb-3">
          ...
          <div class="field mb-2">
            <label class="label"
              ><h5 class="font-weight-500">Today Button</h5></label
            >
            <b-form-checkbox v-model="useTodayIcons">
              Icons
            </b-form-checkbox>
          </div>
        ...
        <b-card class="box">
          ...
          <div class="field mb-2">
            <label class="label"
              ><h5 class="font-weight-200">Start date</h5></label
            >
            <b-form-input
          ...
          <div class="field mb-3">
            <label class="label"
              ><h5 class="font-weight-200">End date</h5></label
            >
            <b-form-input
          ...
          <b-button variant="primary" @click="clickTestAddEvent"
            >Add Event</b-button
          >
        </b-card>
      </b-col>
